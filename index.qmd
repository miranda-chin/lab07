...
For the future, similar projects can work to include other variables beyond policy changes, as well as dive deeper into differences depending on if data is collected on a smaller scale than county or a larger scale, such as by state.
