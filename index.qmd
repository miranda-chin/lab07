...
Ground-level ozone, unlike the protective stratospheric ozone layer, is a harmful air pollutant formed through complex photochemical reactions.
...
We will need to narrow it down substantially in order to only get data for our area of interest, as well as focus on only the parameters which will be relevant to our project.
